...
// //1. filter thoese elements whose price is greater than 100 using filter() method
...
// // chaining way
// const productsOnSales = products.filter((product) => product.price > 100)
//                                 .map((product) => {
//                                     return ` the ${product.name} new price is now ${product.price / 2} NOK`
//                                 });
...
// // destructive way
// // check githun reposotory

// const productOnSaleee = products.filter(({price}) => price > 100)
//                                 .map(({name, price}) => {
